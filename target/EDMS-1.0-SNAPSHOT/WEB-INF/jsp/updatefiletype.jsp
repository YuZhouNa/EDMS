...
<fieldset class="layui-elem-field" style="width: 400px;margin: 20px auto">
    <legend>修改文档类别</legend>
    <div class="layui-field-box" style="margin: 10px auto">
        <form class="layui-form"  lay-filter="example">
                    <input type="hidden" name="typeid" lay-verify="typeid" autocomplete="off" value="${requestScope.typeid}" class="layui-input">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button type="submit" class="layui-btn" lay-submit="" lay-filter="updateFiletype">修改</button>
                </div>
            </div>
        </form>
    </div>
...
<script>
    ...
    layui.use(['form', 'layer','jquery'], function(){
        ...
        //监听提交
        form.on('submit(updateFiletype)', function(data){
            let loading = layer.load(0,{shade:false});
            $.post({
                url:"${pageContext.request.contextPath}/file/updateFiletype",
                data:{
